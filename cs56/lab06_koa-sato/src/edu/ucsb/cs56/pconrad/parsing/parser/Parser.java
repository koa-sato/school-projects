...
public class Parser {
    ...
    public static final Token GREATER_THAN_OR_EQUALS_TOKEN = new GreaterThanOrEqualsToken();
    public static final Token LESS_THAN_OR_EQUALS_TOKEN = new LessThanOrEqualsToken();
