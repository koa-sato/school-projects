...
public class DefaultTokenFactory implements TokenFactory {
    ...
    */
    ...
    /** make a token that represents an equals-equals operator <code>/</code> 
        @return an appropriate token
    */
    ...
    */
    ...
    /** make a token that represents a greater than or equal to <code>/</code> 
       @return an appropriate token
    */

    public Token makeLessThanToken() { return new LessThanToken(); }

    /** make a token that represents a less than or equal to operator <code>/</code> 
        @return an appropriate token
    */

    public Token makeGreaterThanOrEqualsToken() { return new GreaterThanOrEqualsToken(); }

    /** make a token that represents a greater than or equal to operator <code>/</code> 
        @return an appropriate token
    */
