...
public class Tokenizer {
	...
	fsa.addState(13, s -> new LessThanToken() );
	fsa.addState(15, s -> new GreaterThanOrEqualsToken() );
	fsa.addState(17, s -> new LessThanOrEqualsToken() );
	fsa.addState(18, s -> new ExponentToken() );
	...
	fsa.addTransition('<',0,16);
	fsa.addTransition('=',0,17); 
	fsa.addTransition('*',0,18);
	return fsa;
    }
